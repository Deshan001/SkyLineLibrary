...
public class ManageBooksFormController {
    ...
    public void txtEditionOnKeyReleasedAction(KeyEvent keyEvent) {
        Regex.setTextColor(TextFields.NAME,txtEdition);
        System.out.println(Regex.isTextFieldValid(TextFields.NAME,txtEdition.getText()));
    }
}
