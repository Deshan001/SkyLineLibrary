...
import lk.ijse.skylinelibrary.service.custom.impl.BookServiceImpl;
import lk.ijse.skylinelibrary.service.custom.impl.BorrowBookRecordsServiceImpl;
import lk.ijse.skylinelibrary.service.custom.impl.MemberServiceImpl;
import lk.ijse.skylinelibrary.to.*;
...
public class BorrowedBookRecordsController {
    ...
    public void initialize() {
        borrowBookRecordsService = ServiceFactory.getInstance().getService(ServiceType.BORROWBOOKRECORDS);
    ...
    public void setBorrowedBookRecordsTable() {
        ...
        try {
            tblBorrowedBookRecords.setItems(borrowBookRecordsService.getAllBorrowedBookRecords());
    ...
    public void setLabelBorrowedBookRecordsId() {
        try {
            lblBorrowedBookRecordId.setText(borrowBookRecordsService.getBorrowedBookRecordsId());
    ...
    public void btnAddRecordsOnAction(ActionEvent actionEvent) {
        ...
        try {
            boolean flag = borrowBookRecordsService.addBorrowedBookRecords(borrowedBookRecords);
            if (flag) {
    ...
    public void search(String searchBy) throws SQLException, ClassNotFoundException {
        tblBorrowedBookRecords.setItems(borrowBookRecordsService.searchBorrowedBookRecords(searchBy,txtSearch.getText()));
    }
    ...
    public void btnUpdateStatusOnAction(ActionEvent actionEvent) throws SQLException, ClassNotFoundException, IOException {
        ...
        ObservableList<BorrowedBookRecords> borrowed_book_id = borrowBookRecordsService.searchBorrowedBookRecords("Borrowed_Book_Records_ID", borrowed_book_records_id);
        BorrowedBookRecords ob = borrowed_book_id.get(0);
        String dateDifference = borrowBookRecordsService.getDateDifference(ob.getBorrowed_book_records_id());
        ...
        if(i>0){
            ...
            try {
                boolean flag =borrowBookRecordsService.updateStatus(ob);
                if(flag){
