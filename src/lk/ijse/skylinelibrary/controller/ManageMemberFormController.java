...
public class ManageMemberFormController {
    ...
    public void txtAddressOnKeyReleasedAction(KeyEvent keyEvent) {
        Regex.setTextColor(TextFields.ADDRESS,txtAddress);
        System.out.println(Regex.isTextFieldValid(TextFields.ADDRESS,txtAddress.getText()));
    }

    public void txtContactOnKeyReleasedAction(KeyEvent keyEvent) {
        Regex.setTextColor(TextFields.PHONE,txtContact);
        System.out.println(Regex.isTextFieldValid(TextFields.PHONE,txtContact.getText()));
    }
}
