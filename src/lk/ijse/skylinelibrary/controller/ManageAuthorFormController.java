...
import lk.ijse.skylinelibrary.service.custom.impl.AuthorSeviceImpl;
...
public class ManageAuthorFormController {
    ...
    public void setAuthorTable() {
        ...
        try {
            tblAuthor.setItems(authorService.getAll());
    ...
    public void txtAuthorNameOnKeyReleasedAction(KeyEvent keyEvent) {
        Regex.setTextColor(TextFields.NAME,txtAuthorName);
        System.out.println(Regex.isTextFieldValid(TextFields.NAME,txtAuthorName.getText()));
    }
}
